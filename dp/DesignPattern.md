...
| 工厂方法 | 选实现类 | 全局工厂方法 func{switch case () return}，基类 class{class func switch case () return}、class:{private init{super.init}}，class{class func switch case T.self return ()}、class:{private convenience init{self.init} private override init{super.init} override class func{}}，单例 class:{override singleton} |
